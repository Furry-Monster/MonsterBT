...
namespace MonsterBT.Editor.View.Sidebar
{
    public class BTNodeLibrary : VisualElement
    {
        ...
        private static VisualElement CreateNodeListItem(string name, string labelText, string typeText, Type nodeType)
        {
            ...
            item.RegisterCallback<ClickEvent, Type>(
                (_, type) => BTEditorEventBus.PublishNodeRequested(type),
                nodeType);
