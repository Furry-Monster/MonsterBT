...
namespace MonsterBT.Editor.Service.Operation
{
    public class BTNodeOperationService
    {
        ...
        public BTNodeView CreateNode(Type nodeType, Vector2 position,
        ...
        public void DuplicateNode(BTNodeView nodeView, Vector2 offset,
            Func<BTNode, BTNodeView> createNodeView)
        {
